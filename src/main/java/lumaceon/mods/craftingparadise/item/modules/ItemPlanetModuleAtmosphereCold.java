...
public class ItemPlanetModuleAtmosphereCold extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereCold(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.icyAtmosphere;
    }
}
