...
public class ItemPlanetModuleAtmosphereMagic extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereMagic(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.magicInfusedAtmosphere;
    }
}
