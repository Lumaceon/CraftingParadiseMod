...
public class ItemPlanetModuleWorldStandard extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldStandard(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.standardWorld;
    }
}
