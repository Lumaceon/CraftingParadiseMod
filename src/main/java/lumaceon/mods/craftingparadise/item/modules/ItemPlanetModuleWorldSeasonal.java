...
public class ItemPlanetModuleWorldSeasonal extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldSeasonal(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.seasonalWorld;
    }
}
