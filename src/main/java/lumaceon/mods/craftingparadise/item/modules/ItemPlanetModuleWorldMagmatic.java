...
public class ItemPlanetModuleWorldMagmatic extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldMagmatic(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.lavaWorld;
    }
}
