...
public class ItemPlanetModuleWorldMagical extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldMagical(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.essentialWorld;
    }
}
