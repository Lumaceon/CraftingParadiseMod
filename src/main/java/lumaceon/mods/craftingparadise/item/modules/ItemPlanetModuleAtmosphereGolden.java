...
public class ItemPlanetModuleAtmosphereGolden extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereGolden(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.goldenAtmosphere;
    }
}
