...
public class ItemPlanetModuleAtmosphereSwampy extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereSwampy(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.swampyAtmosphere;
    }
}
