...
public class ItemPlanetModuleWorldArid extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldArid(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.aridWorld;
    }
}
