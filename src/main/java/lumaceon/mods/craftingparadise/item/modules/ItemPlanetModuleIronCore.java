...
public class ItemPlanetModuleIronCore extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleIronCore(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.ironCore;
    }
}
