...
public class ItemPlanetModuleWorldLush extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldLush(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.lushWorld;
    }
}
