...
public class ItemPlanetModuleAtmosphereBlue extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereBlue(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.blueAtmosphere;
    }
}
