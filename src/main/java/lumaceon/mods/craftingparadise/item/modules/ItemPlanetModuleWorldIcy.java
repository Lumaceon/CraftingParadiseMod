...
public class ItemPlanetModuleWorldIcy extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldIcy(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.frozenWorld;
    }
}
