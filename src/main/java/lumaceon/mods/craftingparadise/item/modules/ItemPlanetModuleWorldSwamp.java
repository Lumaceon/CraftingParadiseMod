...
public class ItemPlanetModuleWorldSwamp extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldSwamp(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.swampyWorld;
    }
}
