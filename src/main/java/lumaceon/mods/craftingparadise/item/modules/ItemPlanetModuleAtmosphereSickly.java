...
public class ItemPlanetModuleAtmosphereSickly extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleAtmosphereSickly(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.sicklyAtmosphere;
    }
}
