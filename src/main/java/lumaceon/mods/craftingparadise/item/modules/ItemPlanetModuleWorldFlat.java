...
public class ItemPlanetModuleWorldFlat extends ItemMod implements IWorldBuilderModule
{
    public ItemPlanetModuleWorldFlat(int maxStack, int maxDamage, String name) {
    ...
    public PlanetModule getModule(ItemStack stack) {
        return ModPlanetModules.flatWorld;
    }
}
